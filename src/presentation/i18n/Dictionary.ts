...
export const i18nDictionary = {
    pt: {
        ...
        btn_target_lux: "Alvo Lux", btn_manual_grid: "Malha Manual", btn_datasheet: "Ficha Técnica", btn_ies_ldt: "IES / LDT",
        lbl_cct_temp: "Temp. de Cor", lbl_cols_x: "Colunas (X)", lbl_rows_y: "Linhas (Y)",
        lbl_room_color: "Cor do Ambiente (Rebatimento)", opt_ref_light: "Paredes Claras (Branco/Gelo)", opt_ref_med: "Paredes Médias (Cinza/Madeira)", opt_ref_dark: "Paredes Escuras (Preto/Tijolo)",
        btn_lvl_desk: "Nível Mesa", btn_lvl_floor: "Nível Piso", btn_3d_persp: "Perspectiva 3D",
        lbl_isolines: "ISOLINHAS", lbl_polar_curve: "CURVA POLAR", hdr_tech_summary: "DADOS FOTOMÉTRICOS",
        btn_mode_direct: "INTENSIDADE", btn_mode_photo: "FOTOMETRIA", btn_mode_ies: "IES / LDT",
        btn_surf_single: "FONTE ÚNICA", btn_surf_array: "ESTUDO DE FACHO",
        lbl_load_ies: "CARREGAR ARQUIVO .IES / .LDT", lbl_hcl_circadian: "HCL / CIRCADIANO",
        pd_power: "Potência:", pd_flux_nom: "Fluxo Nominal:", pd_flux_fin: "Fluxo Final:", pd_efficacy: "Eficácia:", pd_uplight: "Uplight:",
        lbl_target_em: "Alvo (Em)", lbl_ugr_max: "UGR Máx", opt_cat_def: "Selecione a Categoria (Ex: Escritório)...", opt_room_def: "Selecione a Tarefa / Ambiente...",
        btn_choose_file: "ESCOLHER ARQUIVO", msg_waiting: "AGUARDANDO",
        lbl_proj_name: "NOME DO PROJETO", lbl_proj_room: "AMBIENTE", lbl_proj_author: "RESPONSÁVEL", btn_download_rep: "DOWNLOAD RELATÓRIO",
        msg_no_file: "Nenhum arquivo carregado.", msg_file_loaded: "Carregado:", msg_processing: "Processando fotometria...", msg_file_error: "Erro na leitura do arquivo.",
...
        dr_guard: "Guardião Elétrico", dr_dist: "Distância (m)", dr_gauge: "Bitola (mm²)", dr_drop: "Queda (ΔV)", dr_top: "Topologia Sugerida",
    ...
    en: {
        ...
        btn_target_lux: "Target Lux", btn_manual_grid: "Manual Grid", btn_datasheet: "Datasheet", btn_ies_ldt: "IES / LDT",
        lbl_cct_temp: "Color Temp.", lbl_cols_x: "Columns (X)", lbl_rows_y: "Rows (Y)",
        lbl_room_color: "Room Color (Reflectance)", opt_ref_light: "Light Walls (White)", opt_ref_med: "Medium Walls (Gray/Wood)", opt_ref_dark: "Dark Walls (Black/Brick)",
        btn_lvl_desk: "Desk Level", btn_lvl_floor: "Floor Level", btn_3d_persp: "3D Perspective",
        lbl_isolines: "ISOLINES", lbl_polar_curve: "POLAR CURVE", hdr_tech_summary: "PHOTOMETRIC DATA",
        btn_mode_direct: "INTENSITY", btn_mode_photo: "PHOTOMETRY", btn_mode_ies: "IES / LDT",
        btn_surf_single: "SINGLE SOURCE", btn_surf_array: "BEAM STUDY",
        lbl_load_ies: "UPLOAD .IES / .LDT FILE", lbl_hcl_circadian: "HCL / CIRCADIAN",
        pd_power: "Power:", pd_flux_nom: "Nominal Flux:", pd_flux_fin: "Final Flux:", pd_efficacy: "Efficacy:", pd_uplight: "Uplight:",
        lbl_target_em: "Target (Em)", lbl_ugr_max: "Max UGR", opt_cat_def: "Select Category (Ex: Office)...", opt_room_def: "Select Task / Room...",
        btn_choose_file: "CHOOSE FILE", msg_waiting: "WAITING",
        lbl_proj_name: "PROJECT NAME", lbl_proj_room: "ROOM", lbl_proj_author: "AUTHOR", btn_download_rep: "DOWNLOAD REPORT",
        msg_no_file: "No file loaded.", msg_file_loaded: "Loaded:", msg_processing: "Processing photometry...", msg_file_error: "Error reading file.",
